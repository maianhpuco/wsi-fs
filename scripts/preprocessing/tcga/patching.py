"""
Main module for WSI processing.

This module orchestrates the processing of Whole Slide Images (WSIs) by loading
slides, segmenting tissue, extracting patches, and stitching heatmaps. It uses
configuration and processing modules to handle the workflow.
"""
...
from src.datasets.preprocessing.config import ProcessingConfig, parse_args
...
def process_slide(
    ...
    legacy_support: bool) -> Tuple[float, float, float]:
